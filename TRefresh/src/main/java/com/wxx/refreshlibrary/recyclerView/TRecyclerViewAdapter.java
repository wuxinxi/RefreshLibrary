...
import com.wxx.refreshlibrary.iterfaces.OnItemLongClickListener;
 ...
 */
public class TRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TRecyclerViewAdapter(RecyclerView.Adapter innerAdapter) {
