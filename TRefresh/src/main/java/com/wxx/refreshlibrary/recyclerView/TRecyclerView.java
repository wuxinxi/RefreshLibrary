...
import com.wxx.refreshlibrary.widget.LoadingFoot;
...
public class TRecyclerView extends RecyclerView {
    ...
    private TRecyclerViewAdapter mWrapAdapter;
    ...
    private void init() {
        if (mLoadMoreEnabled) {
            setLoadMoreFooter(new LoadingFoot(getContext().getApplicationContext()));
        }
    ...
    public void setAdapter(Adapter adapter) {
        ...
        mWrapAdapter = (TRecyclerViewAdapter) adapter;
        ...
        public void onChanged() {
            ...
            if (adapter != null && mEmptyView != null) {
                ...
                if (adapter.getItemCount() == 1) {
                    ...
                    TRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
    ...
    public void setLoadingMoreProgressStyle(int style) {
        if (mLoadMoreFooter != null && mLoadMoreFooter instanceof LoadingFoot) {
            ((LoadingFoot) mLoadMoreFooter).setProgressStyle(style);
        }
    ...
    public void setOnNetWorkErrorListener(final OnNetWorkErrorListener listener) {
        final LoadingFoot loadingFooter = ((LoadingFoot) mFootView);
        loadingFooter.setState(LoadingFoot.State.NETERROR);
    ...
    public void setFooterViewHint(String loading, String noMore, String noNetWork) {
        if (mLoadMoreFooter != null && mLoadMoreFooter instanceof LoadingFoot) {
            LoadingFoot loadingFooter = ((LoadingFoot) mLoadMoreFooter);
